//
//  MinMaxAlgorithm.swift
//  TicTacToe
//
//  Created by Michał Nowak on 28/08/2020.
//  Copyright © 2020 none. All rights reserved.
//

import Foundation
    
func evaluatePosition(board: Board, player: Player, opponent: Player) -> Int {
...
func minMax(board: Board, player: Player, opponent: Player, depth: Int, alpha: Int, beta: Int, maximizingPlayer: Bool) -> Int {
    var alpha = alpha
    var beta = beta
...
func minMaxMove(board: Board, player: Player, opponent: Player, depth: Int) -> (Int, Int) {
    var bestVal = -10
